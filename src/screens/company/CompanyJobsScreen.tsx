...
const styles = StyleSheet.create({
  ...
  title: { color: '#fff', fontSize: 28, fontWeight: 'bold', letterSpacing: 0.2 },
  subtitle: { color: '#9aa1c8', marginTop: 6, fontSize: 14, lineHeight: 20 },
  addButton: {
  ...
  card: {
    ...
    ...Platform.select({
      web: {
        boxShadow: '0px 18px 42px rgba(0, 0, 0, 0.2)',
      },
      default: {
        shadowColor: '#000',
        shadowOpacity: 0.18,
  ...
  jobTitle: { color: '#fff', fontSize: 20, fontWeight: '800', marginBottom: 8 },
  jobMeta: { color: '#a3a6bc', marginBottom: 8, fontSize: 13, lineHeight: 20 },
  description: { color: '#d5d5e0', marginTop: 10, lineHeight: 20 },
  skills: { color: '#9ca6ff', marginTop: 12, fontWeight: '700' },
  status: {
    marginTop: 14,
    fontWeight: '700',
    paddingVertical: 8,
